...
var helloGetCmd = &cobra.Command{
  ...
  phog hello get world --json

  # Just the high-gravity fields
  phog hello get world --compact`,
...
var helloListCmd = &cobra.Command{
	...
	Example: `  phog hello list --limit 5 --json`,
	RunE: func(cmd *cobra.Command, args []string) error {
		items := []helloResource{
...
var helloCreateCmd = &cobra.Command{
	...
	Args:  cobra.ExactArgs(1),
	Example: `  phog hello create world --dry-run
  phog hello create world`,
	RunE: func(cmd *cobra.Command, args []string) error {
		if flagDryRun {
